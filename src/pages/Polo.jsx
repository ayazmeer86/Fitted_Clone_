...
const Polo = () => {
    ...
    const {getProductList: pList,getCart:getcart, getSelectedProduct: sProduct, getProductDetail: pDetail, getCollapsed: getColl} = useSelector(state => state.root);
    ...
    return(
        ...
        <div>
            <div className='main' style={{marginLeft: getColl ? "100px" : "0px"}}>
                {
                    pList.filter(itm => (itm.identity.includes("POLO"))).map((pro,i) => {
                        return(
